...
# mesh
reader = FileReader(file_name = "bem/cs_sphere.msh")
...
plotPerTime((0,0,1),0,0.1,0.0001,"bem/output/")
plotPerTime((0,0,2),0,0.1,0.0001,"bem/output/")
plotPerTime((0,0,3),0,0.1,0.0001,"bem/output/")
plotPerTime((0,0,4),0,0.1,0.0001,"bem/output/")
plotPerTime((0,0,5),0,0.1,0.0001,"bem/output/")
